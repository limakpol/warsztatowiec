...
{
    $(document).on('click', '.inputable.category .btn-add', function(event)
    {
    ...
    $(document).on('click', '.inputable.category .btn-edit', function(event)
    {
        event.preventDefault();
    ...
    $(document).on('click', '.inputable.category .btn-remove', function(event)
    {
        event.preventDefault();
