...
{
    $(document).on('click', '.inputable.groupp .btn-add', function(event)
    {
    ...
    $(document).on('click', '.inputable.groupp .btn-edit', function(event)
    {
        event.preventDefault();
    ...
    $(document).on('click', '.inputable.groupp .btn-remove', function(event)
    {
        event.preventDefault();
