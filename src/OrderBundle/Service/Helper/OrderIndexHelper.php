...
class OrderIndexHelper
{
    ...
    public function retrieve($sortableParameters)
    {
        ...
        $customers = $em->getRepository('AppBundle:OrderHeader')->retrieve($workshop, $sortableParameters);
    ...
    public function getOutputSortableParameters($inputSortableParameters)
    {
        ...
        $countAllRetrieved = $em->getRepository('AppBundle:OrderHeader')->getCountAllRetrieved($workshop, $inputSortableParameters);
