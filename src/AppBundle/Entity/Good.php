...
class Good
{
     ...
     * @return Good
     */
    public function addIndexx(\AppBundle\Entity\Indexx $indexx)
    {
        $this->indexxes[] = $indexx;
     ...
     * @param \AppBundle\Entity\Indexx $indexx
     */
    public function removeIndexx(\AppBundle\Entity\Indexx $indexx)
    {
        $this->indexxes->removeElement($indexx);
    }
     ...
     */
    public function getIndexxes()
    {
        return $this->indexxes;
    }
