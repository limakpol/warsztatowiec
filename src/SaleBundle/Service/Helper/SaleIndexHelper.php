...
class SaleIndexHelper
{
    ...
    public function retrieve($sortableParameters)
    {
        ...
        $customers = $em->getRepository('AppBundle:SaleHeader')->retrieve($workshop, $sortableParameters);
    ...
    public function getOutputSortableParameters($inputSortableParameters)
    {
        ...
        $countAllRetrieved = $em->getRepository('AppBundle:SaleHeader')->getCountAllRetrieved($workshop, $inputSortableParameters);
